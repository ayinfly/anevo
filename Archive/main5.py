...
# generated pressing the additional keys like enter
...
#   27 = Enter
#   28 = Backspace
#   29 = left Spacebar marker
#   30 = right Spacebar marker
# If your printout uses different ids, only change the aruco_id numbers below.
# If both spacebar markers are the exact same ArUco marker, set both
# space_left and space_right to that same aruco_id. This script can handle that.
BUTTONS = [
    ButtonSpec("q", 0, "q", "Q"),
    ButtonSpec("w", 1, "w", "W"),
    ButtonSpec("e", 2, "e", "E"),
    ...
    ButtonSpec("space_right", 30, "space", "Spacebar R"),
]
...
def group_detections_by_aruco_id(detections):
    ...
    for marker_id in detections_by_id:
        # Stable left-to-right / top-to-bottom order. This matters only if the
        # same printed ArUco id appears more than once.

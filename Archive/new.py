...
# keep it accurate if the page shifts.
...
def apply_spacebar_press_rule(missing_buttons):
    space_missing = missing_buttons & SPACE_BUTTON_NAMES

    if space_missing and space_missing != SPACE_BUTTON_NAMES:
        return missing_buttons - space_missing
